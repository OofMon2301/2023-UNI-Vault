...
var Field = class {
  ...
  buildColumnMoverBtn(component) {
    const buildBtn = (direction) => {
      const btn = new import_obsidian13.ButtonComponent(component);
  ...
  buildVisibilityBtn(component) {
    this.visibilityButton = new import_obsidian13.ButtonComponent(component).setIcon(this.isColumnHidden ? "eye-off" : "eye").onClick(() => this.setVisibilityButtonState(!this.isColumnHidden));
  }
  ...
  buildFilterComponent() {
    ...
    const filter = new import_obsidian13.TextComponent(fieldFilterContainer);
    const debounced = (0, import_obsidian13.debounce)((fieldset) => fieldset.tableView.udpate(), 1e3, true);
    filter.setValue("");
...
var CreateSavedViewModal = class extends import_obsidian14.Modal {
  ...
  buildModal() {
    ...
    const nameInput = new import_obsidian14.TextComponent(nameContainer);
    nameInput.inputEl.addClass("with-label");
    nameInput.inputEl.addClass("full-width");
    ...
    const infoContainer = actionsContainer.createDiv({ cls: "info" });
    infoContainer.setText("Alt+Enter to save");
    const saveBtn = new import_obsidian14.ButtonComponent(actionsContainer);
    saveBtn.setDisabled(true);
    saveBtn.setIcon("file-plus-2");
    nameErrorContainer.hide();
    nameInput.onChange(async (value) => {
...
var FileClassTableView = class {
  ...
  */
  buildLimitManager(container) {
    ...
    const limitInput = new import_obsidian15.TextComponent(container);
    limitInput.setValue(`${this.limit}`);
    const debounced = (0, import_obsidian15.debounce)((fieldset) => fieldset.tableView.udpate(), 1e3, true);
  ...
  */
  ...
  buildViewSelector() {
    ...
    const options2 = this.fileClass.getFileClassOptions();
    const savedViews = options2.savedViews || [];
    this.viewSelect = new import_obsidian15.DropdownComponent(this.viewSelectContainer);
  ...
  buildSavedViewRemoveButton(container) {
    ...
    this.viewRemoveBtn = new import_obsidian15.ButtonComponent(btnContainer).setIcon("trash").setClass("remove-button").setDisabled(!this.selectedView).setTooltip(`Remove ${this.selectedView} view from the saved views`).onClick(async () => {
      var _a;
      const options2 = this.fileClass.getFileClassOptions();
  ...
  buildFavoriteViewManager(container) {
    const btnContainer = container.createDiv({ cls: "cell" });
    this.favoriteBtn = new import_obsidian15.ButtonComponent(btnContainer);
  ...
  buildCleanFields(container) {
    const btnContainer = container.createDiv({ cls: "cell" });
    const cleanFilterBtn = new import_obsidian15.ButtonComponent(btnContainer);
  ...
  buildSaveView(container) {
    const btnContainer = container.createDiv({ cls: "cell" });
    const saveViewBtn = new import_obsidian15.ButtonComponent(btnContainer);
  ...
  buildHideFilters(container) {
    const btnContainer = container.createDiv({ cls: "cell" });
    const hideFilterBtn = new import_obsidian15.ButtonComponent(btnContainer);
...
var FileClassView = class extends import_obsidian16.ItemView {
...
var FileClassChoiceModal = class extends import_obsidian17.SuggestModal {
...
// src/components/fileClassManager.ts
var FileClassManager = class extends import_obsidian18.Component {
...
var FileClassOptionsList = class {
  ...
  createExtraOptionList(openAfterCreate = true) {
    ...
    let addMissingFieldsAction = () => {
      new import_obsidian19.Notice("Something went wrong, please check your fileClass definitions");
    };
    if (this.fromFile) {
      const dvApi = (_a = this.plugin.app.plugins.plugins.dataview) == null ? void 0 : _a.api;
      if (dvApi) {
...
var OptionsList = class {
  ...
  createAndOpenFieldModal(node) {
    ...
    if (managedField) {
      ...
      new import_obsidian20.Notice("No field with definition at this position", 2e3);
    }
  }
  ...
  buildFieldOptionsForMenu() {
    if (isMenu2(this.location)) {
      ...
      if (view == null ? void 0 : view.editor) {
        const action = async () => {
          if (!view.file || !(view.file instanceof import_obsidian20.TFile))
            return;
  ...
  addFieldAtCurrentPositionOption() {
    var _a;
    const currentView = this.plugin.app.workspace.getActiveViewOfType(import_obsidian20.MarkdownView);
...
var ObjectField = class extends FieldManager2 {
  ...
  createDvField(dv, p, fieldContainer, attrs) {
    ...
    (0, import_obsidian21.setIcon)(editBtn, FieldIcon[this.field.type]);
    editBtn.onclick = async () => {
      const file = this.plugin.app.vault.getAbstractFileByPath(p["file"]["path"]);
      const _eF = file instanceof import_obsidian21.TFile && await Note.getExistingFieldForIndexedPath(this.plugin, file, this.field.id);
      if (_eF)
...
var BaseSuggestModal = class extends import_obsidian22.SuggestModal {
  ...
  buildBackButton(container) {
    const backButton = new import_obsidian22.ButtonComponent(container);
...
// src/modals/BaseModal.ts
var BaseModal = class extends import_obsidian23.Modal {
  ...
  buildSimpleSaveBtn(fieldContainer) {
    ...
    infoContainer.setText("Alt+Enter to save");
    const saveBtn = new import_obsidian23.ButtonComponent(fieldContainer);
...
in <${this.field.name}> ${this.field.fileClassName ? this.field.fileClassName : "Metadata Menu"} settings`;
              if (errorName === "SyntaxError")
                new import_obsidian24.Notice(notice, 5e3);
            }
          } else {
  ...
  buildTemplateInputItem(fieldContainer, name) {
    ...
    const input = new import_obsidian24.TextComponent(fieldContainer);
    input.inputEl.addClass("with-label");
    input.inputEl.addClass("full-width");
  ...
  buildTemplateSelectItem(fieldContainer, name, options2) {
    ...
    fieldContainer.createDiv({ cls: "spacer" });
    const selectEl = new import_obsidian24.DropdownComponent(fieldContainer);
  ...
  buildResultPreview(fieldContainer) {
    this.renderedValue = new import_obsidian24.TextAreaComponent(fieldContainer);
  ...
  buildInputEl(container) {
    const inputEl = new import_obsidian24.TextAreaComponent(container);
...
var InputField = class extends FieldManager2 {
  ...
  createSettingContainer(container, plugin) {
    ...
    const templateValue = new import_obsidian25.TextAreaComponent(templateContainer);
  ...
  createDvField(dv, p, fieldContainer, attrs = {}) {
    ...
    if ((_a = attrs.options) == null ? void 0 : _a.alwaysOn)
      spacer.hide();
    (0, import_obsidian25.setIcon)(editBtn, FieldIcon["Input" /* Input */]);
    ...
    (0, import_obsidian25.setIcon)(validateIcon, "checkmark");
    ...
    (0, import_obsidian25.setIcon)(cancelIcon, "cross");
...
var BooleanModal = class extends BaseModal {
  ...
  buildToggleEl() {
    ...
    const trueButton = new import_obsidian26.ButtonComponent(choicesContainer);
    trueButton.setButtonText("True");
    trueButton.setClass("left");
    choicesContainer.createDiv({ cls: "spacer" });
    const falseButton = new import_obsidian26.ButtonComponent(choicesContainer);
...
var NumberModal = class extends BaseModal {
  ...
  buildInputEl() {
    ...
    this.numberInput = new import_obsidian27.TextComponent(fieldContainer);
    const numberInput = this.numberInput;
    numberInput.inputEl.focus();
    numberInput.setValue(`${this.value || ""}`);
    const minusBtn = new import_obsidian27.ButtonComponent(fieldContainer);
    minusBtn.setButtonText(`- ${!!step ? step : 1}`);
    minusBtn.setDisabled(!this.fieldManager.canDecrement(numberInput.getValue()));
    const plusBtn = new import_obsidian27.ButtonComponent(fieldContainer);
...
var NumberField = class extends FieldManager2 {
  ...
  createNumberContainer(container) {
    ...
    this.numberStepValue = new import_obsidian28.TextComponent(numberStepValueContainer);
    ...
    this.numberMinValue = new import_obsidian28.TextComponent(numberMinValueContainer);
    ...
    this.numberMaxValue = new import_obsidian28.TextComponent(numberMaxValueContainer);
  ...
  createDvField(dv, p, fieldContainer, attrs = {}) {
    ...
    (0, import_obsidian28.setIcon)(editButton, FieldIcon["Number" /* Number */]);
    const decrementButton = fieldContainer.createEl("button");
    (0, import_obsidian28.setIcon)(decrementButton, "left-arrow");
    const incrementButton = fieldContainer.createEl("button");
    (0, import_obsidian28.setIcon)(incrementButton, "right-arrow");
...
// src/modals/BaseSelectModal.ts
var BaseSelecttModal = class extends import_obsidian29.SuggestModal {
  constructor(plugin, file, field, eF, indexedPath, lineNumber = -1, asList = false, asBlockquote = false, previousModal) {
    super(plugin.app);
    this.plugin = plugin;
    this.file = file;
  ...
  buildAddButton(container) {
    this.addButton = new import_obsidian29.ButtonComponent(container);
  ...
  buildFooterActions(footerActionsContainer) {
    ...
    const cancelButton = new import_obsidian29.ButtonComponent(footerActionsContainer);
    cancelButton.setIcon("cross");
    cancelButton.onClick(() => this.close());
    cancelButton.setTooltip("Cancel");
    const clearButton = new import_obsidian29.ButtonComponent(footerActionsContainer);
    ...
    if (fileClassName) {
      ...
      if (fileClass && fileClassAttribute) {
        ...
        if (Array.isArray(fileClassAttribute.options)) {
          ...
          if (valuesFile instanceof import_obsidian29.TFile && valuesFile.extension == "md") {
...
var TextInputSuggest = class {
  constructor(inputEl) {
    ...
    this.scope = new import_obsidian30.Scope();
...
var FileSuggest = class extends TextInputSuggest {
  ...
  getSuggestions(input_str) {
    ...
    all_files.forEach((file) => {
      if (file instanceof import_obsidian31.TFile && file.extension === this.extenstion && file.path.toLowerCase().contains(lower_input_str)) {
        files.push(file);
      }
    });
    return files;
...
var AbstractListBasedField = class extends FieldManager2 {
  ...
  createListNotePathContainer(container, plugin) {
    ...
    const input = new import_obsidian32.TextComponent(valuesListNotePathContainer);
    input.inputEl.addClass("full-width");
    input.inputEl.addClass("with-label");
    new FileSuggest(
      input.inputEl,
  ...
  createValueContainer(parentNode, key) {
    ...
    const input = new import_obsidian32.TextComponent(valueContainer);
    input.inputEl.addClass("full-width");
    ...
    const valueRemoveButton = new import_obsidian32.ButtonComponent(valueContainer);
    ...
    if (key != Object.keys(this.field.options)[0]) {
      const valueUpgradeButton = new import_obsidian32.ButtonComponent(valueContainer);
      (0, import_obsidian32.setIcon)(valueUpgradeButton.buttonEl, "up-chevron-glyph");
  ...
  createValuesFromDVQueryContainer(parentContainer) {
    ...
    const valuesFromDVQuery = new import_obsidian32.TextAreaComponent(valuesFromDVQueryContainer);
  ...
  createSettingContainer(container, plugin, location) {
    ...
    const sourceType = new import_obsidian32.DropdownComponent(sourceTypeContainer);
...
var SelectField = class extends AbstractListBasedField {
  ...
  createDvField(dv, p, fieldContainer, attrs = {}) {
    ...
    (0, import_obsidian33.setIcon)(dropDownButton, "down-chevron-glyph");
    const file = this.plugin.app.vault.getAbstractFileByPath(p["file"]["path"]);
...
var CycleField = class extends AbstractListBasedField {
  ...
  createSettingContainer(container, plugin, location) {
    ...
    const allowNullToggler = new import_obsidian34.ToggleComponent(allowNullValueContainer);
  ...
  createDvField(dv, p, fieldContainer, attrs = {}) {
    ...
    (0, import_obsidian34.setIcon)(cycleBtn, FieldIcon["Cycle" /* Cycle */]);
    if (!((_a = attrs == null ? void 0 : attrs.options) == null ? void 0 : _a.alwaysOn)) {
      cycleBtn.hide();
      spacer.show();
      fieldContainer.onmouseover = () => {
...
var getFiles = (plugin, field, dvQueryString, currentFile) => {
  const getResults = (api) => {
    try {
      ...
      new import_obsidian35.Notice(`Wrong query for field <${field.name}>
...
var AbstractFileBasedField = class extends FieldManager2 {
  ...
  createFileContainer(container) {
    ...
    this.dvQueryString = new import_obsidian35.TextAreaComponent(dvQueryStringContainer);
    ...
    const customRendering = new import_obsidian35.TextAreaComponent(customeRenderingContainer);
    ...
    const customSorting = new import_obsidian35.TextAreaComponent(customSortingContainer);
  ...
  createDvField(dv, p, fieldContainer, attrs = {}) {
    ...
    (0, import_obsidian35.setIcon)(searchBtn, FieldIcon["File" /* File */]);
    const spacer = fieldContainer.createEl("div", { cls: "spacer" });
    const file = this.plugin.app.vault.getAbstractFileByPath(p["file"]["path"]);
...
var FileFuzzySuggester = class extends import_obsidian36.FuzzySuggestModal {
  constructor(plugin, file, field, eF, indexedPath, lineNumber = -1, asList = false, asBlockquote = false, previousModal) {
    var _a;
    super(plugin.app);
    this.plugin = plugin;
  ...
  renderSuggestion(value, el) {
    ...
    if (((_b = this.selectedFile) == null ? void 0 : _b.path) === value.item.path) {
      el.addClass("value-checked");
      const iconContainer = el.createDiv({ cls: "icon-container" });
      (0, import_obsidian36.setIcon)(iconContainer, "check-circle");
    }
    this.inputEl.focus();
  }
...
var MultiSuggestModal = class extends BaseSelecttModal {
  ...
  buildConfirm(footerActionsContainer) {
    ...
    infoContainer.setText("Alt+Enter to save");
    const confirmButton = new import_obsidian37.ButtonComponent(footerActionsContainer);
    confirmButton.setIcon("checkmark");
    confirmButton.onClick(async () => {
      await this.replaceValues();
      this.close();
...
var MultiField = class extends AbstractListBasedField {
  ...
  createDvField(dv, p, fieldContainer, attrs = {}) {
    ...
    currentValues.forEach((v) => {
      ...
      (0, import_obsidian38.setIcon)(valueRemoveBtn, "cross");
      valueRemoveBtn.hide();
...
var DateModal = class extends BaseModal {
  ...
  async save() {
    ...
    if (this.plugin.app.plugins.enabledPlugins.has("nldates-obsidian")) {
      try {
        ...
        newValue = (0, import_obsidian40.moment)(this.value, this.format);
      }
    } else {
      newValue = (0, import_obsidian40.moment)(this.value, this.format);
    }
  ...
  buildInsertAsLinkButton(container) {
    const insertAsLinkBtn = new import_obsidian39.ButtonComponent(container);
  ...
  async buildInputEl(container) {
    ...
    this.inputEl = new import_obsidian39.TextComponent(container);
    this.inputEl.inputEl.focus();
    this.inputEl.setPlaceholder(
      this.initialValue ? (0, import_obsidian40.moment)(this.initialValue, this.field.options.dateFormat).format(this.field.options.dateFormat) : ""
    );
    ...
    const calendarDisplayBtn = new import_obsidian39.ButtonComponent(container);
    calendarDisplayBtn.setIcon(FieldIcon["Date" /* Date */]);
    calendarDisplayBtn.setTooltip("open date picker");
    const shiftFromTodayBtn = new import_obsidian39.ButtonComponent(container);
    ...
    const datePicker = esm_default(datePickerContainer, {
      ...
      defaultDate: (0, import_obsidian40.moment)(Date.now()).format("YYYY-MM-DD")
    });
    datePicker.config.onChange.push((value) => {
      const newDate = (0, import_obsidian40.moment)(value.toString()).format(this.format);
...
var DateField = class extends FieldManager2 {
  ...
  createSettingContainer(container, plugin, location) {
    ...
    const dateFormatInput = new import_obsidian41.TextComponent(dateFormatContainer);
    dateFormatInput.setValue(this.field.options.dateFormat);
    dateExample.setText(`${(0, import_obsidian41.moment)().format(dateFormatInput.getValue())}`);
    dateFormatInput.onChange((value) => {
      this.field.options.dateFormat = value;
      dateExample.setText(`${(0, import_obsidian41.moment)().format(value)}`);
    });
    ...
    const defaultInsertAsLink = new import_obsidian41.ToggleComponent(defaultInsertAsLinkContainer);
    ...
    const dateLinkPathInput = new import_obsidian41.TextComponent(dateLinkPathContainer);
    ...
    const dateShiftInterval = new import_obsidian41.TextComponent(dateShiftIntervalContainer);
    ...
    const nextShiftIntervalField = new import_obsidian41.DropdownComponent(nextShiftIntervalFieldContainer);
  ...
  async getMomentDate(file, indexedPath) {
    ...
    return (0, import_obsidian41.moment)(_dateText, dateFormat);
  }
  async getNewDateValue(currentShift, file, indexedPath) {
    ...
    return _newDate || (0, import_obsidian41.moment)().format(dateFormat);
  }
  ...
  createDvField(dv, p, fieldContainer, attrs = {}) {
    ...
    (0, import_obsidian41.setIcon)(dateBtn, FieldIcon["Date" /* Date */]);
    const spacer = fieldContainer.createDiv({ cls: "spacer-1" });
    this.shiftBtn = fieldContainer.createEl("button");
    (0, import_obsidian41.setIcon)(this.shiftBtn, "skip-forward");
  ...
  displayValue(container, file, value, onClicked) {
    ...
    if (dateLink == null ? void 0 : dateLink.path) {
      ...
      const date = (0, import_obsidian41.moment)(value, dateFormat);
      if (date.isValid()) {
  ...
  validateValue(value) {
    ...
    if (!value) {
      ...
      if (typeof value == "string") {
        return (0, import_obsidian41.moment)(
  ...
  async shiftDuration(file) {
    ...
    if (import_obsidian41.moment.isDuration(import_obsidian41.moment.duration(nextShiftNumber, nextShiftPeriod))) {
...
var MultiFileModal = class extends import_obsidian42.FuzzySuggestModal {
  constructor(plugin, file, field, eF, indexedPath, lineNumber = -1, asList = false, asBlockquote = false, previousModal) {
    var _a;
    super(plugin.app);
    this.plugin = plugin;
    ...
    if (initialOptions) {
      if (Array.isArray(initialOptions)) {
        initialOptions.map((item) => {
          ...
          if (link) {
            const file2 = this.plugin.app.vault.getAbstractFileByPath(link.path);
            if (file2 instanceof import_obsidian42.TFile && !this.selectedFiles.map((_f) => _f.path).includes(file2.path))
        ...
        links.forEach((_link) => {
          ...
          if (link) {
            const file2 = this.plugin.app.vault.getAbstractFileByPath(link.path);
            if (file2 instanceof import_obsidian42.TFile && !this.selectedFiles.map((_f) => _f.path).includes(link.path))
              this.selectedFiles.push(file2);
          }
        });
      }
    ...
    const infoContainer = buttonContainer.createDiv({ cls: "info" });
    infoContainer.setText("Alt+Enter to save");
    const confirmButton = new import_obsidian42.ButtonComponent(buttonContainer);
    confirmButton.setIcon("checkmark");
    confirmButton.onClick(async () => {
      await this.replaceValues();
      this.close();
    });
    const cancelButton = new import_obsidian42.ButtonComponent(buttonContainer);
    cancelButton.setIcon("cross");
    cancelButton.onClick(() => {
      this.close();
    });
    const clearButton = new import_obsidian42.ButtonComponent(buttonContainer);
  ...
  renderSuggestion(value, el) {
    ...
    if (this.selectedFiles.some((file) => file.path === value.item.path)) {
      el.addClass("value-checked");
      const iconContainer = el.createDiv({ cls: "icon-container" });
      (0, import_obsidian42.setIcon)(iconContainer, "check-circle");
    }
  }
  renderSelected() {
    const chooser = this.chooser;
...
async function updateLookups(plugin, forceUpdateOne, forceUpdateAll = false) {
  ...
  await Promise.all([...f.fileLookupFiles.keys()].map(async (lookupFileId) => {
    ...
    if (!file || !(file instanceof import_obsidian43.TFile))
      return;
...
var LookupField = class extends FieldManager2 {
  ...
  createLookupContainer(container) {
    ...
    const autoUpdate = new import_obsidian44.ToggleComponent(autoUpdateContainer);
    ...
    const dvQueryStringContainer = dvQueryStringTopContainer.createDiv({ cls: "field-container" });
    const dvQueryString = new import_obsidian44.TextAreaComponent(dvQueryStringContainer);
    ...
    const targetFieldName = new import_obsidian44.TextComponent(targetFieldContainer);
    ...
    const outputTypeList = new import_obsidian44.DropdownComponent(outputTypeContainer);
    ...
    const builtinSummarizeFunctionList = new import_obsidian44.DropdownComponent(builtinSummarizeFunctionContainer);
    ...
    const summarizedFieldName = new import_obsidian44.TextComponent(summarizedFieldNameContainer);
    ...
    const outputRenderingFunction = new import_obsidian44.TextAreaComponent(outputRenderingFunctionContainer);
    ...
    const outputSummarizingFunction = new import_obsidian44.TextAreaComponent(outputSummarizingFunctionContainer);
...
async function updateFormulas(plugin, forceUpdateOne, forceUpdateAll = false) {
  ...
  await Promise.all([...fileFormulasFields].map(async ([id, field]) => {
    ...
    if (!_file || !(_file instanceof import_obsidian45.TFile))
      return;
...
var FormulaField = class extends FieldManager2 {
  ...
  createFormulaContainer(container) {
    ...
    autoUpdateContainer.createEl("span", { text: "Auto update this field ", cls: "label" });
    autoUpdateContainer.createDiv({ cls: "spacer" });
    const autoUpdate = new import_obsidian46.ToggleComponent(autoUpdateContainer);
    autoUpdateTopContainer.createEl("span", { text: "This could lead to latencies depending on the queries", cls: "sub-text warning" });
    if (this.field.options.autoUpdate === void 0)
      this.field.options.autoUpdate = false;
    autoUpdate.setValue(this.field.options.autoUpdate);
    ...
    const formula = new import_obsidian46.TextAreaComponent(formulaContainer);
  ...
  constructor(plugin, field, type) {
    ...
    this.buildColorsContainer = (container, colorList, label) => {
      ...
      const toggleStandardColorButton = (container2, color) => {
        if (colorList.includes(color)) {
          ...
          (0, import_obsidian47.setIcon)(container2, "cross");
        } else {
          container2.removeClass("active");
          (0, import_obsidian47.setIcon)(container2, "plus");
        }
        ;
      };
      ...
      const toggleAltColors = () => {
        ...
        altGroupColors.forEach((color) => {
          ...
          (0, import_obsidian47.setIcon)(colorContainer, "cross");
          colorContainer.onclick = () => {
      ...
      const altColorPicker = new import_obsidian47.ColorComponent(altColorPickerContainer);
    ...
    this.buildEdgeSideContainer = (container, edgeList, label) => {
      ...
      this.sides.forEach(([side, iconName]) => {
        ...
        (0, import_obsidian47.setIcon)(sideIconContainer, iconName);
        const sideTogglerContainer = new import_obsidian47.ToggleComponent(edgeSideContainer);
    ...
    this.buildLabelsContainer = (container, labels, title) => {
      ...
      labels.forEach((label) => {
        ...
        new import_obsidian47.ButtonComponent(labelContainer).setIcon("x-circle").setClass("item-remove").onClick(() => {
          labels.remove(label);
    ...
    this.buildNewLabelContainer = (currentLabelsContainer, currentLabelsTitle, newLabelContainer, labels, title) => {
      ...
      const labelInput = new import_obsidian47.TextComponent(newLabelContainer);
      const labelValidate = new import_obsidian47.ButtonComponent(newLabelContainer);
    ...
    this.createCanvasPathContainer = (container) => {
      ...
      const canvasPathInput = new import_obsidian47.TextComponent(container);
    ...
    this.createDirectionContainer = (container, title) => {
      ...
      container.createDiv({ cls: "spacer" });
      const directionSelection = new import_obsidian47.DropdownComponent(container);
      [
        ["incoming", "Incoming"],
        ["outgoing", "Outgoing"],
    ...
    this.createDvQueryContainer = (container, title) => {
      ...
      const filesFromDVQuery = new import_obsidian47.TextAreaComponent(filesFromDVQueryContainer);
...
var RawObjectField = class extends FieldManager2 {
  ...
  createDvField(dv, p, fieldContainer, attrs = {}) {
    ...
    if ((_a = attrs.options) == null ? void 0 : _a.alwaysOn)
      spacer.hide();
    (0, import_obsidian48.setIcon)(editBtn, FieldIcon["Input" /* Input */]);
    if (!((_b = attrs == null ? void 0 : attrs.options) == null ? void 0 : _b.alwaysOn)) {
      editBtn.hide();
      spacer.show();
      fieldContainer.onmouseover = () => {
...
var ObjectListModal = class extends BaseSuggestModal {
  ...
  buildAddButton(container) {
    ...
    const addButton = new import_obsidian49.ButtonComponent(container);
  ...
  renderSuggestion(item, el) {
    ...
    (0, import_obsidian49.setIcon)(removeContainer, "trash");
...
var ObjectListField = class extends FieldManager2 {
  ...
  */
  ...
  createDvField(dv, p, fieldContainer, attrs) {
    ...
    fieldContainer.appendChild(fieldValue);
    const editBtn = fieldContainer.createEl("button");
    (0, import_obsidian50.setIcon)(editBtn, FieldIcon[this.field.type]);
    editBtn.onclick = async () => {
      const file = this.plugin.app.vault.getAbstractFileByPath(p["file"]["path"]);
      const _eF = file instanceof import_obsidian50.TFile && file.extension == "md" && await Note.getExistingFieldForIndexedPath(this.plugin, file, this.field.id);
      if (_eF)
        this.createAndOpenFieldModal(file, this.field.name, _eF, _eF.indexedPath);
    };
  }
...
var FieldOptions = class {
  ...
  addOption(icon, onclick, tooltip, className) {
    ...
    const fieldOption = new import_obsidian51.ButtonComponent(fieldOptionContainer);
...
var FieldsModal = class extends import_obsidian51.Modal {
  ...
  buildNavigation() {
    ...
    const backBtn = new import_obsidian51.ButtonComponent(backBtnWrapper);
  ...
  buildFieldContainer(container, field, value, indexedPath) {
    ...
    const fieldSettingBtn = new import_obsidian51.ButtonComponent(fieldSettingContainer);
    ...
    if (this.existingFields.map((_f) => _f.field.id).includes(field.id)) {
      ...
      const fieldBtn = new import_obsidian51.ButtonComponent(fieldBtnContainer);
      ...
      ancestors.forEach(async (fileClassName, i) => {
        ...
        if (_fileClass) {
          ...
          if (await _fileClass.missingFieldsForFileClass(this.file)) {
            const fileClassInsertMissingFieldsInFrontmatterBtn = new import_obsidian51.ButtonComponent(fileClassOptionsContainer);
            ...
            const fileClassInsertMissingFieldsBtn = new import_obsidian51.ButtonComponent(fileClassOptionsContainer);
          ...
          const fileClassAddAttributeBtn = new import_obsidian51.ButtonComponent(fileClassOptionsContainer);
  ...
  buildInsertMissingFieldsBtn() {
    ...
    const insertMissingFieldsInFrontmatterBtn = new import_obsidian51.ButtonComponent(insertMissingFieldsContainer);
    ...
    const insertMissingFieldsBtn = new import_obsidian51.ButtonComponent(insertMissingFieldsContainer);
  ...
  buildInsertNewItem(field, indexedPath) {
    ...
    const insertNewItemBtn = new import_obsidian51.ButtonComponent(insertNewItemContainer);
...
var NoteFieldsComponent = class extends import_obsidian51.Component {
...
function addFileClassAttributeOptions(plugin) {
  ...
  plugin.addCommand({
    ...
    checkCallback: (checking) => {
      const view = plugin.app.workspace.getActiveViewOfType(import_obsidian52.MarkdownView);
    ...
    checkCallback: (checking) => {
      ...
      if (inFileClass) {
        try {
          ...
          new import_obsidian52.Notice("plugin is not a valid fileClass");
        }
      }
    }
  });
            ...
            case "source":
              {
                ...
                if (node)
                  ...
                  new import_obsidian52.Notice("No field with definition at this position", 2e3);
              }
              break;
            case "preview": {
...
function addOpenFieldsModalCommand(plugin) {
  ...
  plugin.addCommand({
    ...
    checkCallback: (checking) => {
      ...
      if (inFile) {
        const file = view.file;
        if (inFile && file instanceof import_obsidian52.TFile && file.extension === "md") {
...
var ContextMenu = class extends import_obsidian53.Component {
  constructor(plugin) {
    super();
    this.plugin = plugin;
  ...
  buildOptions(file, menu) {
    ...
    if (file instanceof import_obsidian53.TFile && file.extension === "md") {
      if (!import_obsidian53.Platform.isMobile && (0, import_obsidian53.requireApiVersion)("0.16.0")) {
...
function setLinkMetadataFormButton(plugin, link, destPath, viewTypeName, fileClassName) {
  ...
  if (classFilessPath && fileClass) {
    ...
    if (!(el == null ? void 0 : el.hasClass("fileclass-icon"))) {
      ...
      if (metadataMenuBtn) {
        (0, import_obsidian54.setIcon)(metadataMenuBtn, icon);
  ...
  const viewPlugin = import_view3.ViewPlugin.fromClass(
    class {
      ...
      buildDecorations(view) {
        ...
        const mdView = view.state.field(import_obsidian55.editorInfoField);
        let lastAttributes = {};
...
// src/components/ExtraButton.ts
var ExtraButton = class extends import_obsidian56.Component {
  constructor(plugin) {
    super();
    this.plugin = plugin;
    this.modalObservers = [];
  ...
  onload() {
    ...
    this.registerEvent(this.plugin.app.metadataCache.on("changed", (0, import_obsidian56.debounce)(this.updateLinks, 100, true)));
    this.registerEvent(this.plugin.app.workspace.on("metadata-menu:indexed", (0, import_obsidian56.debounce)(this.updateLinks, 100, true)));
    this.registerEvent(this.plugin.app.workspace.on("layout-change", (0, import_obsidian56.debounce)(this.updateLinks, 10, true)));
    ...
    this.registerEvent(this.plugin.app.internalPlugins.getPluginById("bookmarks").instance.on("changed", (0, import_obsidian56.debounce)(this.updateLinks, 100, true)));
  }
  initViewObservers() {
...
var FileClassQuery = class {
  ...
  getResults(api) {
    try {
      ...
      new import_obsidian57.Notice(`Wrong query for <${this.name}>. Check your settings`);
      return [];
    }
  }
  matchFile(file) {
  ...
  canvases.forEach(async (canvas) => {
    ...
    if (rawContent) {
      try {
        ...
        new import_obsidian58.Notice(`Couldn't read ${canvas.path}`);
      }
    }
    ...
    currentFiles.forEach(async ({ cumulatedLinksFields, cumulatedGroupsFields, cumulatedGroupsLinksFields }, filePath) => {
      ...
      if (file && file instanceof import_obsidian58.TFile) {
    ...
    previousFilesPaths.filter((f2) => !currentFilesPaths.includes(f2)).forEach(async (filePath) => {
      ...
      if (targetFile && targetFile instanceof import_obsidian58.TFile) {
        const payload = [];
  ...
  for (const file of files) {
    ...
    if (index.classFilesPath && file.path.startsWith(this.classFilesPath)) {
      ...
      await Promise.all(canvasFields.map(async (field) => {
        ...
        if (canvasFile instanceof import_obsidian58.TFile && canvasFile.extension === "canvas") {
...
var FieldIndexBuilder = class extends import_obsidian59.Component {
  constructor(plugin) {
    super();
    this.plugin = plugin;
    this.changedFiles = [];
    ...
    canvases.forEach(async (canvas) => {
      ...
      if (rawContent) {
        try {
          ...
          DEBUG && console.log(error);
          new import_obsidian60.Notice(`Couldn't read ${canvas.path}`);
        }
      }
...
var IndexStatus = class extends import_obsidian61.Component {
  constructor(plugin) {
    super();
    this.plugin = plugin;
  ...
  onload() {
    ...
    this.statusBtn = new import_obsidian61.ButtonComponent(container);
  ...
  checkForUpdate(view) {
    if (view && view instanceof import_obsidian61.FileView && view.file) {
...
var FolderSuggest = class extends TextInputSuggest {
  ...
  getSuggestions(inputStr) {
    ...
    abstractFiles.forEach((folder) => {
      if (folder instanceof import_obsidian65.TFolder && folder.path.toLowerCase().contains(lowerCaseInputStr)) {
        folders.push(folder);
      }
    });
    return folders;
...
var FileClassQuerySetting = class extends import_obsidian66.Setting {
...
// src/settings/FileClassQuerySettingModal.ts
var FileClassQuerySettingsModal = class extends import_obsidian67.Modal {
  ...
  createnameInputContainer(container) {
    ...
    const input = new import_obsidian67.TextComponent(container);
    input.inputEl.addClass("with-label");
    input.inputEl.addClass("full-width");
  ...
  createFileClassSelectorContainer(container) {
    ...
    container.createDiv({ cls: "spacer" });
    const select = new import_obsidian67.DropdownComponent(container);
    const classFilesPath = this.plugin.settings.classFilesPath;
  ...
  createQueryInputContainer(container) {
    ...
    const queryStringInput = new import_obsidian67.TextAreaComponent(queryStringInputContainer);
  ...
  createSaveButton(container) {
    const b = new import_obsidian67.ButtonComponent(container);
    b.setTooltip("Save");
    b.setIcon("checkmark");
    b.onClick(async () => {
      var _a;
...
// src/settings/MetadataMenuSettingTab.ts
var SettingTextWithButtonComponent = class extends import_obsidian68.Setting {
  constructor(plugin, containerEl, name, description, placeholder, currentValues, normalizeValue) {
    ...
    this.newValues = [];
    const saveButton = new import_obsidian68.ButtonComponent(this.containerEl);
...
var ButtonDisplaySetting = class extends import_obsidian68.Setting {
...
var MetadataMenuSettingTab = class extends import_obsidian68.PluginSettingTab {
  constructor(plugin) {
  ...
  createSettingGroup(title, subTitle, withButton = false) {
    ...
    if (withButton) {
      ...
      const settingsContainerShowButton = new import_obsidian68.ButtonComponent(settingsContainerShowButtonContainer);
  ...
  display() {
    ...
    new import_obsidian68.Setting(globalSettings).setName("Scope").setDesc("Index fields in frontmatter only or in the whole note (if you use dataview inline fields). Indexing full notes could cause some latencies in vaults with large files").addDropdown((cb) => {
    ...
    new import_obsidian68.Setting(globalSettings).setName("Display field options in context menu").setDesc("Choose to show or hide fields options in the context menu of a link or a file").addToggle((toggle) => {
    ...
    const enableAutoComplete = new import_obsidian68.Setting(globalSettings).setName("Autocomplete").setDesc("Activate autocomplete fields").addToggle((cb) => {
    ...
    const showIndexingStatus = new import_obsidian68.Setting(globalSettings).setName("Fields Indexing Status").setDesc("Show fields indexing status icon in status toolbar").addToggle((cb) => {
    ...
    const frontmatterListDisplay = new import_obsidian68.Setting(globalSettings).setName("Frontmatter list display").setDesc("Choose wether lists should be displayed as arrays or indented lists in frontmatter").addDropdown((cb) => {
    ...
    new import_obsidian68.Setting(globalSettings).setName("First day of week").setDesc("For date fields, which day the date picker's week should start with").addDropdown((cb) => {
      for (let i = 0; i < 2; i++) {
        cb.addOption(i.toString(), (0, import_obsidian68.moment)().day(i).format("dddd"));
      }
    ...
    new import_obsidian68.Setting(presetFieldsSettings).setName("Add New Field Setting").setDesc("Add a new Frontmatter property for which you want preset options.").addButton((button) => {
    ...
    const fileClassesFolderSaveButton = new import_obsidian68.ButtonComponent(classFilesSettings);
    ...
    const path = new import_obsidian68.Setting(classFilesSettings).setName("class Files path").setDesc("Path to the files containing the authorized fields for a type of note").addSearch((cfs) => {
    ...
    const aliasSaveButton = new import_obsidian68.ButtonComponent(classFilesSettings);
    ...
    const alias = new import_obsidian68.Setting(classFilesSettings).setName("fileClass field alias").setDesc("Choose another name for fileClass field in frontmatter (example: Category, type, ...").addText((text) => {
    ...
    const global = new import_obsidian68.Setting(classFilesSettings).setName("global fileClass").setDesc("Choose one fileClass to be applicable to all files (even it is not present as a fileClass attribute in their frontmatter). This will override the preset Fields defined above").addSearch((cfs) => {
      new FileSuggest(
        cfs.inputEl,
        this.plugin,
    ...
    const rowPerPageSaveButton = new import_obsidian68.ButtonComponent(classFilesSettings);
    ...
    const maxRows = new import_obsidian68.Setting(classFilesSettings).setName("Result per page").setDesc("Number of result per page in table view").addText((text) => {
    ...
    const showFileClassSelectInModal = new import_obsidian68.Setting(classFilesSettings).setName("Fileclass Select").setDesc("Show fileclass select option in note fields modals").addToggle((cb) => {
    ...
    new import_obsidian68.Setting(metadataMenuBtnSettings).setName("Metadata Menu button icon").setDesc("name of the default icon when not defined in fileClass").addText((text) => {
    ...
    new import_obsidian68.Setting(queryFileClassSettings).setName("Add New Query for fileClass").setDesc("Add a new query and a FileClass that will apply to files matching this query.").addButton((button) => {
...
var listPrefix = "  - ";
var ValueSuggest = class extends import_obsidian69.EditorSuggest {
  constructor(plugin) {
    super(plugin.app);
  ...
  async selectSuggestion(suggestion, event) {
    var _a, _b, _c, _d, _e;
    const activeView = this.plugin.app.workspace.getActiveViewOfType(import_obsidian69.MarkdownView);
    if (!activeView) {
      return;
    }
    ;
    ...
    if (this.inFrontmatter && file) {
      try {
        ...
        let parsedField2 = (0, import_obsidian69.parseYaml)(serializedField);
  ...
  - ${clean(value)}`).join("")}`;
        ...
        new import_obsidian69.Notice("Frontmatter wrongly formatted", 2e3);
        this.close();
        return;
      }
...
var updateProps = async (plugin, view) => {
  if (!(view instanceof import_obsidian70.MarkdownView) || !(view.file instanceof import_obsidian70.TFile) || view.file === void 0)
    return;
  const file = view.file;
  ...
  view.metadataEditor.rendered.forEach((item) => {
    ...
    if (plugin.settings.enableProperties) {
      ...
      const btn = new import_obsidian70.ButtonComponent(btnContainer);
  ...
  fileClasses == null ? void 0 : fileClasses.forEach((fileClass) => {
    const addFieldButton = new import_obsidian70.ButtonComponent(fileClassButtonsContainer);
...
async function updatePropertiesSection(plugin) {
  ...
  const currentView = plugin.app.workspace.getActiveViewOfType(import_obsidian70.MarkdownView);
...
var FileClassFolderButton = class extends import_obsidian71.Component {
  constructor(plugin) {
    super();
    this.plugin = plugin;
    this.addButton();
  ...
  addButton() {
    ...
    if (!container.findAll(".fileClass-add-button").length) {
      ...
      (0, import_obsidian71.setIcon)(addBtn, "plus-circle");
      addBtn.onclick = (e) => {
        e.preventDefault();
...
// main.ts
var MetadataMenu = class extends import_obsidian72.Plugin {
  constructor() {
    super(...arguments);
    this.presetFields = [];
...
------------------------------------------`,
    ...
    this.registerEvent(
      this.app.workspace.on("metadata-menu:indexed", () => {
        ...
        const currentView = this.app.workspace.getActiveViewOfType(import_obsidian72.MarkdownView);
        if (currentView)
